...
namespace Project
{
    public partial class DeleteTeacher : MetroFramework.Forms.MetroForm
    {
        string UserID;
        ...
        private void DeleteTeacher_Load(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM UserData WHERE User_Type = 'Faculty'", con);
        ...
        private void Deletebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("DELETE FROM UserData WHERE UserID = @UserID", con);
