...
namespace Project {
    ...
    public partial class ProjectDataSet2 : global::System.Data.DataSet {
        ...
        public partial class DepartmentDataDataTable : global::System.Data.TypedTableBase<DepartmentDataRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DepartmentDataRow AddDepartmentDataRow(string DepName) {
    ...
    public partial class DepartmentDataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[DepartmentData] WHERE (([DepID] = @Original_DepID) AND ((@IsNu" +
                "ll_DepName = 1 AND [DepName] IS NULL) OR ([DepName] = @Original_DepName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DepartmentData] ([DepName]) VALUES (@DepName);\r\nSELECT DepID, " +
                "DepName FROM DepartmentData WHERE (DepID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[DepartmentData] SET [DepName] = @DepName WHERE (([DepID] = @Origina" +
                "l_DepID) AND ((@IsNull_DepName = 1 AND [DepName] IS NULL) OR ([DepName] = @Origi" +
                "nal_DepName)));\r\nSELECT DepID, DepName FROM DepartmentData WHERE (DepID = @DepID" +
                ")";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DepID, DepName FROM dbo.DepartmentData";
        ...
        public virtual int Fill(ProjectDataSet2.DepartmentDataDataTable dataTable) {
        ...
        public virtual ProjectDataSet2.DepartmentDataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProjectDataSet2.DepartmentDataDataTable dataTable = new ProjectDataSet2.DepartmentDataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProjectDataSet2.DepartmentDataDataTable dataTable) {
...
SELECT UserID, FirstName, LastName, MobileNo, Address, DateOfBirth, Gender, City, Username, Email, Password, Usertype, Picture, DepID FROM UserData WHERE (UserID = @UserID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ProjectDataSet2.UserDataDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ProjectDataSet2.UserDataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProjectDataSet2.UserDataDataTable dataTable = new ProjectDataSet2.UserDataDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProjectDataSet2.UserDataDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
